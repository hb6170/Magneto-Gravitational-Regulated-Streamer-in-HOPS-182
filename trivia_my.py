...
def make_ppv(path, clip=3., rmin=None, rmax=None, N=None, cmin=None, cmax=None, constant_opacity=None, ntrace=20, 
        marker_size=4, cmap=None, hoverinfo='x+y+z', xaxis_title=None, 
...
#         print(source_ra_off,source_dec_off,source_vel)
    ...
    if bool_traj:
        if traj != None:
            ...
            traj_line += [go.Scatter3d(x=traj[0], y=traj[1], z=traj[2], mode='lines', line=dict(color='black', width=10))] 
...
#                       margin=dict(l=0, r=0, b=0, t=0), 
    ...
    if show_colorbar:
        fig.update_traces(marker_colorbar=dict(thickness=10, 
